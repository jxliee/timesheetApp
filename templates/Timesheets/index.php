 ...
 */
?>
<div class="timesheets index content">
    <?= $this->Html->link(__('New Timesheet'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Timesheets') ?></h3>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $timesheet->timesheet_id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $timesheet->timesheet_id]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $timesheet->timesheet_id], ['confirm' => __('Are you sure you want to delete # {0}?', $timesheet->timesheet_id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
